/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config server/wrangler.jsonc server/worker-configuration.d.ts` (hash: 9f292c23cd8856421a559dc4b6efd85f)
// Runtime types generated with workerd@1.20260526.1 2026-05-27 
interface __BaseEnv_Env {
	ROOMS: DurableObjectNamespace<import("./src/index").RoomDurableObject>;
}
